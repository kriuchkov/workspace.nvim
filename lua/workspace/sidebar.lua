...
local VIEWS = {
  { id = 'explorer', icon = ic(0xf07c), label = 'Explorer', kind = 'panel',
    open  = function() require('workspace.filetree').open(nil, S.ab_win) end,
    close = function() require('workspace.filetree').close() end },
  { id = 'search', icon = ic(0xf002), label = 'Search', kind = 'launch',
    run = function() require('workspace.search').live_grep() end },
  { id = 'git', icon = ic(0xf126), label = 'Git', kind = 'panel',
    open  = function() require('workspace.git_ui').open(S.ab_win) end,
    close = function() require('workspace.git_ui').close() end },
  { id = 'outline', icon = ic(0xf0e8), label = 'Outline', kind = 'panel',
    open  = function() require('workspace.outline').open(S.ab_win) end,
    close = function() require('workspace.outline').close() end },
  { id = 'diagnostics', icon = ic(0xf188), label = 'Diagnostics', kind = 'panel',
    open  = function() require('workspace.diag_panel').open(S.ab_win) end,
  ...
  { id = 'tasks', icon = ic(0xf0ae), label = 'Tasks', kind = 'launch',
    run = function() require('workspace.claude.commands').pick() end },
}
local BY_ID, ORDER = {}, {}
