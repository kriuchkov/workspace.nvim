...
local palette = require('workspace.theme.palette')
...
local function apply()
  ...
  local hl = {
    ...
    Question      = { fg = c.blue },
    -- Message / command-line area: a distinct dark background so system messages
    -- and typed commands read as chrome, matching the statusline/sidebar tone.
    MsgArea       = { fg = c.fg, bg = c.bg_dark },
    MsgSeparator  = { fg = c.border_dim, bg = c.bg_dark },
